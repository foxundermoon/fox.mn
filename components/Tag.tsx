...
const useStyles = makeStyles((theme: Theme) =>
  createStyles({
    ...
    job:{
      boxShadow: '0 4px 10px 0 rgba(0, 0, 0,.14), 0 7px 8px -5px rgba(255, 152, 0,.4)',
      backgroundImage: 'linear-gradient(60deg, rgba(255, 167, 38,.2), rgba(251, 140, 0,.2))',
...
export const R :FunctionComponent<{v:number}> = ({children, v})=>{
  ...
  return(
    <Rating name="read-only" value={v} readOnly 
    precision={0.5}
